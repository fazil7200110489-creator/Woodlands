        ...
        {visible && (
          ...
          >
            ...
            <div className="rounded-[32px] border border-[#BF976A]/20 bg-white/80 p-10 shadow-[0_24px_80px_rgba(0,0,0,0.08)] backdrop-blur-md text-center">
              ...
              >
                {/* Track My Order — only for orders (not bookings) */}
                {!isBooking && orderId && (
                  <a
                    href={`/order/${orderId}`}
                    id="track-order-btn"
                    className="flex items-center justify-center gap-2 w-full rounded-full bg-[#1D0F07] py-4 font-mono-num text-[10px] uppercase tracking-[0.2em] text-white transition-opacity hover:opacity-80"
                  >
