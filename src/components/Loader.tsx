...
export default function Loader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <div ref={rootRef} className="fixed inset-0 z-[10001] bg-[#FBF8F3]">
      <div ref={topRef} className="absolute inset-x-0 top-0 h-1/2 bg-[#FBF8F3]" />
      <div ref={bottomRef} className="absolute inset-x-0 bottom-0 h-1/2 bg-[#FBF8F3]" />
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-6">
        ...
        <div className="h-px w-56 overflow-hidden bg-[#1D0F07]/10">
